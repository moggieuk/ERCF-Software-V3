...
You can still control the gear stepper motor with the `MANUL_STEPPER` command, however, this will only be effective if the stepper is not currently syncing with the extruder.
